      ...
      <div className={styles.content}>
        ...
        <div className={styles.benefits_cards} ref={ref} {...events}>
          ...
          <BenefitCard
            ...
            text={
              'Основанная на нашем опыте, качестве услуг и рыночных стандартах, чтобы обеспечить максимальную ценность и эффективность в каждом вашем проекте'
            }
            icon={rub}
          />
          <BenefitCard
            ...
            text={
              'Опыт и компетенции нашей команды будут служить гарантом создания продукта отличного качества, воплощающего передовые инновации'
            }
            icon={hands}
          />
          <BenefitCard
